    ...
    <section className="text-white bg-gray-900 body-font items-center text-center">
      ...
      <div className="container px-5 py-10 mx-auto flex flex-wrap">
        <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
          <img
            alt="feature"
            className=" object-center h-full w-full md:w-[70%]"
            src={tamilbro}
          />
        </div>
        <div className="flex flex-col flex-wrap lg:py-6 lg:w-1/2 lg:pl-12 lg:text-left text-center">
          ...
          <div className="flex flex-col  lg:items-start items-center">
            ...
            <div className="flex-grow">
              ...
              <a href='https://www.ptuniv.edu.in/ece/faculty?id=65' target="_blank" className={`mt-3 text-${props.theme}-500 inline-flex items-center`}>
                Learn More
                <svg
                  fill="none"
                  stroke="currentColor"
